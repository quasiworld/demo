...
public class MyX509TrustManager implements X509TrustManager {
    public static void main(String[] args) {
        ...
        String path = "D:/";
        String urls = "https://www.xbiquge.la/files/article/image/56/56523/56523s.jpg";
    ...
    public static void downLoadFromUrlHttps(String urlStr, String fileName,
        ...
        // 打开连接
        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
        conn.setRequestProperty("Cookie", "_abcde_qweasd=0; Hm_lvt_169609146ffe5972484b0957bd1b46d6=1652106856,1652144699,1652523816,1652603149; _abcde_qweasd=0; Hm_lpvt_169609146ffe5972484b0957bd1b46d6=1652604197");
        /**
         * 这一步的原因: 当访问HTTPS的网址。您可能已经安装了服务器证书到您的JRE的keystore
         * 但是服务器的名称与证书实际域名不相等。这通常发生在你使用的是非标准网上签发的证书。
         *
